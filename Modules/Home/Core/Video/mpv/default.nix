...
home.file."${config.xdg.configHome}/mpv/scripts/SmartCopyPaste_II.lua" = {
  recursive = true;
  source = builtins.fetchurl {
  url = "https://raw.githubusercontent.com/Eisa01/mpv-scripts/master/scripts/SmartCopyPaste_II.lua";
  sha256 = "1r4s3wwzqljdyzccp94s24zbfhbradfdkz90zi15ncralx72dwx8";
  };
};

xdg.configFile."${config.xdg.configHome}/mpv/script-opts/SmartCopyPaste_II.conf".text = with pkgs; ''
